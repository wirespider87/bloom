...
<details>
<summary><strong>Xmake Package Setup</strong> - use <code>bloom-packages</code> and <code>add_requires("bloom 1.0.4")</code></summary>
...
```lua
add_requires("bloom 1.0.4", {configs = {d3d11 = true}})
```
